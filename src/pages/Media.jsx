...
class Media extends Component {
  ...
  createData = newData => {
    return axios
      .post(`${Constants.BASE_API_ENDPOINT}/media`, newData)
      .then(response => {
  ...
  readData = () => {
    return axios
      .get(`${Constants.BASE_API_ENDPOINT}/media`)
      .then(response => {
        this.setState({
          data: response.data
        });
  ...
  updateData = newData => {
    return axios
      .put(`${Constants.BASE_API_ENDPOINT}/media/${newData.uuid}`, newData)
      .then(response => {
        const responseBody = response.data;
  ...
  deleteData = uuid => {
    return axios
      .delete(`${Constants.BASE_API_ENDPOINT}/media/${uuid}`)
      .then(response => {
